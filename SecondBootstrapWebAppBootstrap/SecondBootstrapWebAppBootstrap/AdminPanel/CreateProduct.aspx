<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanelMasterPage.Master" AutoEventWireup="true" CodeBehind="CreateProduct.aspx.cs" Inherits="SecondBootstrapWebAppBootstrap.AdminPanel.CreateProduct" %>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-3 mt-3">
                                ...
                                <asp:CheckBox ID="cd_Discontinued" runat="server" CssClass="form-check-input"></asp:CheckBox>
                                <label for="ContentPlaceHolder1_cd_Discontinued" class="form-check-label">
                                    Satıştan
                                    Kaldır</label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-3 mt-3">
                                ...
                                <asp:CheckBox ID="cb_FastProduct" runat="server" CssClass="form-check-input"></asp:CheckBox>
                                <label for="ContentPlaceHolder1_cb_FastProduct" class="form-check-label">
                                    Hızlı
                                    Satışa
                                    Ekle</label>
                            </div>
